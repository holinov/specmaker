    ...
    */
    ...
    $stateProvider.rails = function () {
      $stateProvider
        ...
        .state('selectable_entries_entry_infos_path', {
          url: '/entry_infos/selectable_entries',
          
          templateUrl: function(params) {
            params['ng-view']='';
            
            
            return Routes['selectable_entries_entry_infos_path'](params);
          },
          controller: 'EntryInfosCtrl as ctrl',
          resolve: {
            action: ['$stateParams', function ($stateParams) {
              return resolve('selectable_entries', $stateParams)
            }]
          }
        })
        ...
        .state('entries_projects_path', {
          url: '/projects/entries',
          
          templateUrl: function(params) {
            params['ng-view']='';
            
            
            return Routes['entries_projects_path'](params);
          },
          controller: 'ProjectsCtrl as ctrl',
          resolve: {
            action: ['$stateParams', function ($stateParams) {
              return resolve('entries', $stateParams)
            }]
          }
        })
      
        .state('selectable_entries_projects_path', {
          url: '/projects/selectable_entries',
          
          templateUrl: function(params) {
            params['ng-view']='';
            
            
            return Routes['selectable_entries_projects_path'](params);
          },
          controller: 'ProjectsCtrl as ctrl',
          resolve: {
            action: ['$stateParams', function ($stateParams) {
  ...
  .factory('resourceDecorator', [function () {
    ...
    .factory('EntryInfo', ['$resource', 'resourceDecorator', function ($resource, resourceDecorator) {
      return resourceDecorator($resource('/entry_infos/:id.json', {"id":"@id"}, {
        ...
        "selectable_entries": {
          "url": "/entry_infos/selectable_entries.json",
          "isArray": true,
          "method": "GET"
        },
        "update_items": {
    ...
    .factory('Project', ['$resource', 'resourceDecorator', function ($resource, resourceDecorator) {
      return resourceDecorator($resource('/projects/:id.json', {"id":"@id"}, {
        ...
        "entries": {
          "url": "/projects/entries.json",
          "isArray": true,
          "method": "GET"
        },
        "selectable_entries": {
          "url": "/projects/selectable_entries.json",
          "isArray": true,
          "method": "GET"
        },
        "update_items": {
          "url": "/projects/update_items.json",
          "isArray": null,
          "method": "POST"
        }
      }));
