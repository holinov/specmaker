...
Group.create(name: 'sub_test', group_id: g1.id)

e1 = EntryInfo.create(name: 'pump', group: g1)

f1 = Field.create(value: 3, field_info: fi1, entry_info: e1)
f1 = Field.create(value: 3, field_info: fi2, entry_info: e1)
f1 = Field.create(value: 3, field_info: fi3, entry_info: e1)
f1 = Field.create(value: 3, field_info: fi4, entry_info: e1)
